...
// Package v1alpha1 contains the Cluster-scoped DNSView managed resource.
// API group: dnsview.infobloxnios.crossplane.io
package v1alpha1
...
// DNSView is the Cluster-scoped managed resource representing an Infoblox NIOS DNSView.
type DNSView struct {
