...
// Package v1alpha1 contains the Cluster-scoped HostRecord managed resource.
// API group: hostrecord.infobloxnios.crossplane.io
package v1alpha1
...
// HostRecord is the Cluster-scoped managed resource representing an Infoblox NIOS HostRecord.
