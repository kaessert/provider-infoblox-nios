...
// Package v1alpha1 contains the Cluster-scoped AliasRecord managed resource.
// API group: recordalias.infobloxnios.crossplane.io
package v1alpha1
...
// AliasRecord is the Cluster-scoped managed resource representing an Infoblox NIOS AliasRecord.
