...
// Package v1alpha1 contains the Cluster-scoped MXRecord managed resource.
// API group: recordmx.infobloxnios.crossplane.io
package v1alpha1
...
// MXRecord is the Cluster-scoped managed resource representing an Infoblox NIOS MXRecord.
