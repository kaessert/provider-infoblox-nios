...
// Package v1alpha1 contains the Cluster-scoped SRVRecord managed resource.
// API group: recordsrv.infobloxnios.crossplane.io
package v1alpha1
...
// SRVRecord is the Cluster-scoped managed resource representing an Infoblox NIOS SRVRecord.
