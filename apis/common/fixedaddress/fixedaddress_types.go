...
// Package fixedaddress contains a standalone reference copy of the Parameters
// and Observation types for the FixedAddress managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/fixedaddress/,
// apis/namespaced/fixedaddress/) generate self-contained copies of these same
