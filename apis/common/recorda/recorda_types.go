...
// Package recorda contains a standalone reference copy of the Parameters
// and Observation types for the ARecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recorda/,
// apis/namespaced/recorda/) generate self-contained copies of these same
