...
// Package recordaaaa contains a standalone reference copy of the Parameters
// and Observation types for the AAAARecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recordaaaa/,
// apis/namespaced/recordaaaa/) generate self-contained copies of these same
