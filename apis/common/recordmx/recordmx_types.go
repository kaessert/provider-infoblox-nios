...
// Package recordmx contains a standalone reference copy of the Parameters
// and Observation types for the MXRecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recordmx/,
// apis/namespaced/recordmx/) generate self-contained copies of these same
