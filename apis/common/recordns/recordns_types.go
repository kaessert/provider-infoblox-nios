...
// Package recordns contains a standalone reference copy of the Parameters
// and Observation types for the NSRecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recordns/,
// apis/namespaced/recordns/) generate self-contained copies of these same
