...
// Package recordptr contains a standalone reference copy of the Parameters
// and Observation types for the PTRRecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recordptr/,
// apis/namespaced/recordptr/) generate self-contained copies of these same
