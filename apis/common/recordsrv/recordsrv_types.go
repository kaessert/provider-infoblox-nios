...
// Package recordsrv contains a standalone reference copy of the Parameters
// and Observation types for the SRVRecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recordsrv/,
// apis/namespaced/recordsrv/) generate self-contained copies of these same
