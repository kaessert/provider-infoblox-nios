...
// Package recordtxt contains a standalone reference copy of the Parameters
// and Observation types for the TXTRecord managed resource. The
// cluster-scoped and namespaced variants (apis/cluster/recordtxt/,
// apis/namespaced/recordtxt/) generate self-contained copies of these same
