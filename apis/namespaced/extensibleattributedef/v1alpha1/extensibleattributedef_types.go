...
// API group: extensibleattributedef.infobloxnios.m.crossplane.io
package v1alpha1
...
// ExtensibleAttributeDef is the Namespaced-scoped managed resource representing an Infoblox NIOS ExtensibleAttributeDef.
