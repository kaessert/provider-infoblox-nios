...
// Package v1alpha1 contains the Namespaced-scoped FixedAddress managed resource.
// API group: fixedaddress.infobloxnios.m.crossplane.io
package v1alpha1
...
// FixedAddress is the Namespaced-scoped managed resource representing an Infoblox NIOS FixedAddress.
