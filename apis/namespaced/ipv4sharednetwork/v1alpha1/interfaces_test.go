...
// Compile-time assertions that IPv4SharedNetwork satisfies the crossplane-runtime
...
var (
	_ resource.Managed       = &IPv4SharedNetwork{}
	_ resource.ModernManaged = &IPv4SharedNetwork{}
)
