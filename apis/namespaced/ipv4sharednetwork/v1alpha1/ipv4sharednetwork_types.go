...
// Package v1alpha1 contains the Namespaced-scoped IPv4SharedNetwork managed resource.
// API group: ipv4sharednetwork.infobloxnios.m.crossplane.io
package v1alpha1
...
type IPv4SharedNetworkParameters struct {
	...
	// +optional
	NetworksRefs []xpv2.NamespacedReference `json:"networksRefs"`
	// +optional
	NetworksSelector *xpv2.NamespacedSelector `json:"networksSelector,omitempty"`
...
// IPv4SharedNetwork is the Namespaced-scoped managed resource representing an Infoblox NIOS IPv4SharedNetwork.
