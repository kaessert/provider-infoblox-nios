...
// Compile-time assertions that NetworkContainer satisfies the crossplane-runtime
...
var (
	_ resource.Managed       = &NetworkContainer{}
	_ resource.ModernManaged = &NetworkContainer{}
)
