...
// Package v1alpha1 contains the Namespaced-scoped Range managed resource.
// API group: range.infobloxnios.m.crossplane.io
package v1alpha1
...
// Range is the Namespaced-scoped managed resource representing an Infoblox NIOS Range.
type Range struct {
