...
// Package v1alpha1 contains the Namespaced-scoped CNAMERecord managed resource.
// API group: recordcname.infobloxnios.m.crossplane.io
package v1alpha1
...
type CNAMERecordParameters struct {
	...
	// +optional
	CanonicalRef *xpv1.NamespacedReference `json:"canonicalRef,omitempty"`
	// +optional
	CanonicalSelector *xpv1.NamespacedSelector `json:"canonicalSelector,omitempty"`
...
// CNAMERecord is the Namespaced-scoped managed resource representing an Infoblox NIOS CNAMERecord.
