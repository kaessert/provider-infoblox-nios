...
// Package v1alpha1 contains the Namespaced-scoped NSRecord managed resource.
// API group: recordns.infobloxnios.m.crossplane.io
package v1alpha1
...
// NSRecord is the Namespaced-scoped managed resource representing an Infoblox NIOS NSRecord.
