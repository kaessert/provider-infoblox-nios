...
// API group: zonedelegated.infobloxnios.m.crossplane.io
package v1alpha1
...
// ZoneDelegated is the Namespaced-scoped managed resource representing an Infoblox NIOS ZoneDelegated.
