...
func (c *clusterConnector) Connect(ctx context.Context, cr *clusterv1alpha1.DNSView) (managed.TypedExternalClient[*clusterv1alpha1.DNSView], error) {
	...
	return &clusterExternal{kube: c.kube, conn: conn.Connector, endpoint: conn.Endpoint}, nil
}
...
func (e *clusterExternal) Observe(ctx context.Context, cr *clusterv1alpha1.DNSView) (managed.ExternalObservation, error) {
	...
	cr.Status.AtProvider = clusterObservationFromFields(observed, v.Ref, strPtrOrNil(v.Ref), &v.IsDefault, cloudInfo)
...
func (e *clusterExternal) Create(ctx context.Context, cr *clusterv1alpha1.DNSView) (managed.ExternalCreation, error) {
...
func (e *clusterExternal) Delete(ctx context.Context, cr *clusterv1alpha1.DNSView) (managed.ExternalDelete, error) {
...
func setupClusterDNSView(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*clusterv1alpha1.DNSView](driftdetection.WrapConnector[*clusterv1alpha1.DNSView](&clusterConnector{
			kube:  mgr.GetClient(),
