...
func newClients(creds *nioCredentials, sslVerify bool) (*dtcPoolClients, error) {
...
func newClientsWithScheme(creds *nioCredentials, sslVerify bool, scheme, port string) (*dtcPoolClients, error) {
