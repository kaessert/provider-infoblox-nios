...
func setupClusterExtensibleAttributeDef(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*clusterv1alpha1.ExtensibleAttributeDef](driftdetection.WrapConnector[*clusterv1alpha1.ExtensibleAttributeDef](&clusterConnector{
			kube:  mgr.GetClient(),
