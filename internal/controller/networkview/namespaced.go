...
type namespacedExternal struct {
	...
	// against directly — see resolveNetworkViewIdentity.
...
func (e *namespacedExternal) Observe(ctx context.Context, cr *namespacedv1alpha1.NetworkView) (managed.ExternalObservation, error) {
...
func (e *namespacedExternal) Create(ctx context.Context, cr *namespacedv1alpha1.NetworkView) (managed.ExternalCreation, error) {
...
// ladder first.
func (e *namespacedExternal) Delete(ctx context.Context, cr *namespacedv1alpha1.NetworkView) (managed.ExternalDelete, error) {
	externalID := meta.GetExternalName(cr)
...
func setupNamespacedNetworkView(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*namespacedv1alpha1.NetworkView](driftdetection.WrapConnector[*namespacedv1alpha1.NetworkView](&namespacedConnector{
			kube:  mgr.GetClient(),
