...
func (e *namespacedExternal) Observe(_ context.Context, cr *namespacedv1alpha1.Range) (managed.ExternalObservation, error) {
...
// the external name.
func (e *namespacedExternal) Create(_ context.Context, cr *namespacedv1alpha1.Range) (managed.ExternalCreation, error) {
	p := cr.Spec.ForProvider
...
func (e *namespacedExternal) Update(_ context.Context, cr *namespacedv1alpha1.Range) (managed.ExternalUpdate, error) {
	p := cr.Spec.ForProvider
	externalID := meta.GetExternalName(cr)
...
// Delete removes the Range. A 404 is treated as already-deleted
// (idempotent).
...
func setupNamespacedRange(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*namespacedv1alpha1.Range](&namespacedConnector{
			kube:  mgr.GetClient(),
