...
func (e *namespacedExternal) Observe(ctx context.Context, cr *namespacedv1alpha1.RangeTemplate) (managed.ExternalObservation, error) {
...
func (e *namespacedExternal) Create(ctx context.Context, cr *namespacedv1alpha1.RangeTemplate) (managed.ExternalCreation, error) {
...
func (e *namespacedExternal) Update(ctx context.Context, cr *namespacedv1alpha1.RangeTemplate) (managed.ExternalUpdate, error) {
	p := cr.Spec.ForProvider
...
func (e *namespacedExternal) Delete(ctx context.Context, cr *namespacedv1alpha1.RangeTemplate) (managed.ExternalDelete, error) {
	externalID := meta.GetExternalName(cr)
...
func setupNamespacedRangeTemplate(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*namespacedv1alpha1.RangeTemplate](driftdetection.WrapConnector[*namespacedv1alpha1.RangeTemplate](&namespacedConnector{
			kube:  mgr.GetClient(),
