...
func (e *clusterExternal) Update(_ context.Context, cr *clusterv1alpha1.ARecord) (managed.ExternalUpdate, error) {
	p := cr.Spec.ForProvider
	externalID := meta.GetExternalName(cr)
...
func setupClusterARecord(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*clusterv1alpha1.ARecord](&clusterConnector{
			kube:  mgr.GetClient(),
