...
func newObjectManager(creds *nioCredentials) (ibclient.IBObjectManager, ibclient.IBConnector, error) {
...
func newObjectManagerWithScheme(creds *nioCredentials, scheme, port string) (ibclient.IBObjectManager, ibclient.IBConnector, error) {
