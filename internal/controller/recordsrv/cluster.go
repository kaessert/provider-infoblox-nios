...
func (e *clusterExternal) Observe(ctx context.Context, cr *clusterv1alpha1.SRVRecord) (managed.ExternalObservation, error) {
...
func (e *clusterExternal) Create(ctx context.Context, cr *clusterv1alpha1.SRVRecord) (managed.ExternalCreation, error) {
	p := cr.Spec.ForProvider
...
// ladder first.
func (e *clusterExternal) Delete(ctx context.Context, cr *clusterv1alpha1.SRVRecord) (managed.ExternalDelete, error) {
	externalID := meta.GetExternalName(cr)
...
func setupClusterSRVRecord(mgr ctrl.Manager, o controller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*clusterv1alpha1.SRVRecord](driftdetection.WrapConnector[*clusterv1alpha1.SRVRecord](&clusterConnector{
			kube:  mgr.GetClient(),
