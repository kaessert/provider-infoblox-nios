...
func (e *clusterExternal) Observe(_ context.Context, cr *clusterv1alpha1.ZoneAuth) (managed.ExternalObservation, error) {
	...
	cr.Status.AtProvider = clusterv1alpha1.ZoneAuthObservation{
		ID:                  externalID,
		...
		GridPrimary:         clusterMemberServersFromValues(observed.GridPrimary),
		GridSecondaries:     clusterMemberServersFromValues(observed.GridSecondaries),
		ExternalPrimaries:   clusterExternalServersFromValues(observed.ExternalPrimaries),
		ExternalSecondaries: clusterExternalServersFromValues(observed.ExternalSecondaries),
