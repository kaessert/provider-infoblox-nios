// Package zonedelegated read/write endpoint split (read-routing) tests.
//
...
func TestNamespacedObserveReadEndpointAbsentNoCandidateCall(t *testing.T) {
	...
	cr := newNamespacedZoneDelegated("team-a", "my-zone", ref, "ProviderConfig")
...
// classification: even with a fully configured candidate/gate, ZoneDelegated
