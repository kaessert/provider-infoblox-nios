	...
	return ResourceDescriptor{
		...
		Fields: []FieldDef{
			...
			},
			{
				...
				GoType:      goTypeInt64,
				Scope:       FieldScopeBoth,
				Description: "The Time To Live (TTL), in seconds, of the synthetic DNS responses resulting from blacklist redirection.",
			},
			{
			...
			},
			{
				...
				GoType:      goTypeInt64,
				Scope:       FieldScopeBoth,
				Description: "The number of seconds to cache lame delegations or lame servers.",
			},
			{
				Name:        "UseLameTTL",
				JSONName:    "useLameTtl",
			...
			},
			{
				...
				GoType:      goTypeInt64,
				Scope:       FieldScopeBoth,
				Description: "The Time To Live (TTL), in seconds, of the synthetic DNS responses resulting from NXDOMAIN redirection.",
			},
			{
		...
		NestedTypes: []NestedTypeDef{
			...
			},
			{
				...
				Fields: []FieldDef{
					...
					{Name: "ResponsesPerSecond", JSONName: "responsesPerSecond", GoType: goTypeInt64, Description: "The number of responses per client per second."},
					{Name: "Window", JSONName: "window", GoType: goTypeInt64, Description: "The time interval in seconds over which responses are tracked."},
					{Name: "Slip", JSONName: "slip", GoType: goTypeInt64, Description: "The response rate limiting slip. If slip is not 0, every n-th rate-limited UDP request is sent a truncated response instead of being dropped."},
				},
			},
			{
			...
			},
			{
				...
				Fields: []FieldDef{
					...
					{Name: "Every", JSONName: "every", GoType: goTypeInt64, Description: "The number of frequency units to wait before repeating the scheduled task."},
					{Name: "MinutesPastHour", JSONName: "minutesPastHour", GoType: goTypeInt64, Description: "The minutes past the hour for the scheduled task."},
					{Name: "HourOfDay", JSONName: "hourOfDay", GoType: goTypeInt64, Description: "The hour of day for the scheduled task."},
					{Name: "Year", JSONName: "year", GoType: goTypeInt64, Description: "The year for the scheduled task."},
					{Name: "Month", JSONName: "month", GoType: goTypeInt64, Description: "The month for the scheduled task."},
					{Name: "DayOfMonth", JSONName: "dayOfMonth", GoType: goTypeInt64, Description: "The day of the month for the scheduled task."},
