...
// Package v1alpha1 contains the Namespaced-scoped ARecord managed resource.
// API group: recorda.infobloxnios.m.crossplane.io
package v1alpha1
...
// ARecord is the Namespaced-scoped managed resource representing an Infoblox NIOS ARecord.
type ARecord struct {
